...
export function HomePage() {
  ...
  return (
    <div className="w-full space-y-10 select-none pb-10">
      ...
      {data.mode === "guest" ? (
        <GuestHero query={query} setQuery={setQuery} submitSearch={submitSearch} />
      ) : (
        <UserHero
      ...
      <form onSubmit={submitSearch} className="max-w-2xl mx-auto relative flex items-center gap-2 px-2">
        <div className="relative flex-1">
          ...
          <Input
            ...
            placeholder="Type a research topic (e.g. large language model education)..."
            className="w-full pl-11 pr-4 h-12 rounded-xl border-slate-200 dark:border-slate-800 focus-visible:ring-1 focus-visible:ring-ring bg-card"
          />
        </div>
